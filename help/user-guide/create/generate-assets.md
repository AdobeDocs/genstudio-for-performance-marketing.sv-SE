...
Om du vill skapa en _[!DNL On-brand images]_&#x200B;väljer du en befintlig bild som sparats i [!DNL Content]. Mer information om [-dimensioner som stöds finns i &#x200B;](/help/user-guide/templates/best-practices-for-templates.md#follow-channel-specific-template-guidelines)Bästa tillvägagångssätt för mallar[!DNL on-brand image].
