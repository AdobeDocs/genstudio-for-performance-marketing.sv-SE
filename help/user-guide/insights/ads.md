...
1. Välj en eller flera kampanjer från den resulterande sökningen och klicka på **[!UICONTROL Apply]**.
   ...
   Dina valda kampanjer visas nu i listan _[!UICONTROL Filter by]_ovanför annonstabellen eller galleriet, så att du kan fokusera på annonserna som är kopplade till de valda kampanjerna.
