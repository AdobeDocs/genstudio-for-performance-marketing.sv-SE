...
- [Alternativ text](/help/user-guide/templates/customize-template.md#alternative-text)
- [Hjälpmedelsetikett](/help/user-guide/templates/customize-template.md#accessibility-label)
