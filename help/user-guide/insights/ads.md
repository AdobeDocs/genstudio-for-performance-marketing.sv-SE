...
| **Attribut** | Lista över inbyggda funktioner i den här annonsen. | Kan hjälpa er att identifiera kreativa element som intresserar er bäst. Se [Kategorier](/help/user-guide/insights/attributes.md#categories). |
...
| **Attribut** | Lista över inbyggda funktioner i den här annonsplaceringen. | Kan hjälpa er att identifiera kreativa element som intresserar er bäst. Se [Kategorier](/help/user-guide/insights/attributes.md#categories). |
